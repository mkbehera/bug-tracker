...
try{
	...
	Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","bug","bugtracker");
	Statement stmt = con.createStatement();
	String loginid1=(String)session.getAttribute("loginid");     
	String query = "select * from bug where authorid='"+loginid1+"'" + "order by bugid desc";
